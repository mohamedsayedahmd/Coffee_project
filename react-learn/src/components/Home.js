...
function Home(){
    return(
        ...
        <span className={styles.home}> <h1>This is a Home component</h1>
        ...
        <div className={styles.list}>
            <ul>
                ...
                <li>To me, the smell of fresh-made coffee is one of the greatest inventions.</li>
                <li>I like coffee exceedingly…</li>
                <li>What goes best with a cup of coffee? Another cup.</li>
            </ul>
        </div>
        <img className="img-fluid"
        // height={10} width={1100} 
         src="https://coffeeaffection.com/wp-content/uploads/2020/07/divider-2-e1596661368562.webp" 
         alt="MDN logo"/>
